export default function PersonaCard({
  ...
  return (
      <button
        ...
        className="hud-panel group min-h-24 min-w-0 overflow-hidden rounded-md p-3 text-left transition hover:-translate-y-0.5 hover:border-[var(--accent-bright)] md:min-h-0 md:p-3"
      >
